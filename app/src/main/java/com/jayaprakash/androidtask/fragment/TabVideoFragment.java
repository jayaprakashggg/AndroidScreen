...
public class TabVideoFragment extends Fragment implements FragmentViewAdapter.ItemClickListener{

    RecyclerView recyclerView;
    FragmentViewAdapter customListAdapter;
    ArrayList<FragmentData> servicesDatas = new ArrayList<>();
    Integer id[] = {R.mipmap.sliding_one,R.mipmap.sliding_two,R.mipmap.sliding_three,R.mipmap.sliding_four};
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i=0;i<4;i++){
            ...
            data.setTitle("Videos Details data "+i);
            data.setTime(""+(i+2)+" days ago");
        ...
        customListAdapter.setClickListener(TabVideoFragment.this);
