...
public class TabImageFragment extends Fragment implements FragmentViewAdapter.ItemClickListener{

    RecyclerView recyclerView;
    FragmentViewAdapter customListAdapter;
    ArrayList<FragmentData> servicesDatas = new ArrayList<>();
    Integer id[] = {R.mipmap.sliding_four,R.mipmap.sliding_three,R.mipmap.sliding_one,R.mipmap.sliding_two};
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i=0;i<4;i++){
            ...
            data.setTitle("Images Details data "+i);
            data.setTime(""+(i+5)+" days ago");
        ...
        customListAdapter.setClickListener(TabImageFragment.this);
